...
// { race
	...
	char*       race_route_name;
	char*       race_route_description;
	int         race_route_timeout;
	int         race_route_weapon_mode;
	int         race_route_falsestart_mode;
	float       race_route_start_yaw;
	float       race_route_start_pitch;
// }
