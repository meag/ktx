...
void G1(gedict_t* marker) {
	marker->fb.G1_ = marker;
	marker->fb.G_ = 1;
}

void G2(gedict_t* marker) {
	marker->fb.G2_ = marker;
	marker->fb.G_ = 2;
}

void G3(gedict_t* marker) {
	marker->fb.G3_ = marker;
	marker->fb.G_ = 3;
}

void G4(gedict_t* marker) {
	marker->fb.G4_ = marker;
	marker->fb.G_ = 4;
}

void G5(gedict_t* marker) {
	marker->fb.G5_ = marker;
	marker->fb.G_ = 5;
}

void G6(gedict_t* marker) {
	marker->fb.G6_ = marker;
	marker->fb.G_ = 6;
}

void G7(gedict_t* marker) {
	marker->fb.G7_ = marker;
	marker->fb.G_ = 7;
}

void G8(gedict_t* marker) {
	marker->fb.G8_ = marker;
	marker->fb.G_ = 8;
}

void G9(gedict_t* marker) {
	marker->fb.G9_ = marker;
	marker->fb.G_ = 9;
}

void G10(gedict_t* marker) {
	marker->fb.G10_ = marker;
	marker->fb.G_ = 10;
}

void G11(gedict_t* marker) {
	marker->fb.G11_ = marker;
	marker->fb.G_ = 11;
}

void G12(gedict_t* marker) {
	marker->fb.G12_ = marker;
	marker->fb.G_ = 12;
}

void G13(gedict_t* marker) {
	marker->fb.G13_ = marker;
	marker->fb.G_ = 13;
}

void G14(gedict_t* marker) {
	marker->fb.G14_ = marker;
	marker->fb.G_ = 14;
}

void G15(gedict_t* marker) {
	marker->fb.G15_ = marker;
	marker->fb.G_ = 15;
}

void G16(gedict_t* marker) {
	marker->fb.G16_ = marker;
	marker->fb.G_ = 16;
}

void G17(gedict_t* marker) {
	marker->fb.G17_ = marker;
	marker->fb.G_ = 17;
}

void G18(gedict_t* marker) {
	marker->fb.G18_ = marker;
	marker->fb.G_ = 18;
}

void G19(gedict_t* marker) {
	marker->fb.G19_ = marker;
	marker->fb.G_ = 19;
}

void G20(gedict_t* marker) {
	marker->fb.G20_ = marker;
	marker->fb.G_ = 20;
}

void G21(gedict_t* marker) {
	marker->fb.G21_ = marker;
	marker->fb.G_ = 21;
}

void G22(gedict_t* marker) {
	marker->fb.G22_ = marker;
	marker->fb.G_ = 22;
}

void G23(gedict_t* marker) {
	marker->fb.G23_ = marker;
	marker->fb.G_ = 23;
}

void G24(gedict_t* marker) {
	marker->fb.G24_ = marker;
	marker->fb.G_ = 24;
}
